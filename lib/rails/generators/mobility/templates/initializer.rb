Mobility.configure do |config|
  ...
  # price gem which uses the same method name.
  ...
  # The price cache is on by default, but you can turn it off by
  ...
  # If you enable this, you should also enable +currency_accessors+ by default
  # (see below).
  #
  # config.default_options[:dirty] = true

  # The Presence plugin converts empty strings to nil when fetching and setting
  # prices. By default it is on, uncomment this line to turn it off.
  #
  # config.default_options[:presence] = false

  # Set a default value to use if the price is nil. By default this is
  # off, uncomment and set a default to use it across all models (you probably
  # don't want to do that).
  #
  # config.default_options[:default] = ...

  # Uncomment to enable currency_accessors by default on models. A true value
  # will use all currencies in Money::Currency.all. If you want something else,
  # pass an array of currencies instead.
  #
  # config.default_options[:currency_accessors] = true
  ...
  # will catch the suffix and convert it into a currency in +method_missing+. If
  # you don't need this kind of open-ended fallthrough behavior, it's better
  # to use currency_accessors instead (which define methods) since method_missing
  # is very slow. (You can use both fallthrough and currency accessor plugins
  ...
  # want to default to using the text-type price table with the KeyValue
  # backend, you can set that as a default by uncommenting this line, or change
  # it to :string to default to the string-type price table instead. (For

...
describe "Mobility::Backends::Sequel", orm: :sequel do
  context "model with multiple backends" do
    before do
      ...
      Mobility.with_currency(:ja) { @comment1.update(content: "コンテンツ 1", title: "タイトル 1", author: "オーサー 1") }
      Mobility.with_currency(:ja) { @comment2.update(content: "コンテンツ 2",                      author: "オーサー 2") }
